...
export const PollsApiAxiosParamCreator = function (configuration?: Configuration) {
  return {
     ...
     */
    pollsControllerCreate: async (createPollDto: CreatePollDto, options: any = {}): Promise<RequestArgs> => {
      // verify required parameter 'createPollDto' is not null or undefined
      assertParamExists('pollsControllerCreate', 'createPollDto', createPollDto);
      ...
      localVarRequestOptions.data = serializeDataIfNeeded(createPollDto, localVarRequestOptions, configuration);
     ...
     * @throws {RequiredError}
     */
    pollsControllerJoin: async (joinPollDto: JoinPollDto, options: any = {}): Promise<RequestArgs> => {
      ...
      localVarRequestOptions.data = serializeDataIfNeeded(joinPollDto, localVarRequestOptions, configuration);
     ...
     * @throws {RequiredError}
     */
    pollsControllerRejoin: async (rejoinPollDto: RejoinPollDto, options: any = {}): Promise<RequestArgs> => {
      // verify required parameter 'rejoinPollDto' is not null or undefined
      assertParamExists('pollsControllerRejoin', 'rejoinPollDto', rejoinPollDto);
      ...
      localVarRequestOptions.data = serializeDataIfNeeded(rejoinPollDto, localVarRequestOptions, configuration);
...
export const PollsApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    async pollsControllerCreate(
      ...
      options?: any
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<CreatePollVoUnifiedRes>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.pollsControllerCreate(createPollDto, options);
    ...
    async pollsControllerJoin(
      ...
      options?: any
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<JoinPollVoUnifiedRes>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.pollsControllerJoin(joinPollDto, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
    /**
     *
    ...
    async pollsControllerRejoin(
      ...
      options?: any
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<RejoinPollVoUnifiedRes>> {
      const localVarAxiosArgs = await localVarAxiosParamCreator.pollsControllerRejoin(rejoinPollDto, options);
      return createRequestFunction(localVarAxiosArgs, globalAxios, BASE_PATH, configuration);
    },
  };
};
...
export const PollsApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    pollsControllerCreate(createPollDto: CreatePollDto, options?: any): AxiosPromise<CreatePollVoUnifiedRes> {
      return localVarFp.pollsControllerCreate(createPollDto, options).then(request => request(axios, basePath));
    },
    /**
     *
     * @param {JoinPollDto} joinPollDto
     ...
     * @throws {RequiredError}
     */
    pollsControllerJoin(joinPollDto: JoinPollDto, options?: any): AxiosPromise<JoinPollVoUnifiedRes> {
      return localVarFp.pollsControllerJoin(joinPollDto, options).then(request => request(axios, basePath));
    },
    /**
     *
     * @param {RejoinPollDto} rejoinPollDto
     ...
     * @throws {RequiredError}
     */
    pollsControllerRejoin(rejoinPollDto: RejoinPollDto, options?: any): AxiosPromise<RejoinPollVoUnifiedRes> {
      return localVarFp.pollsControllerRejoin(rejoinPollDto, options).then(request => request(axios, basePath));
    },
  };
};
